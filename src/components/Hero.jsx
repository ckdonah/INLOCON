...
import { ArrowRight, Sparkles, Search, Target, Zap, TrendingUp, Shield, CheckCircle } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-32 right-32 w-40 h-40 bg-gradient-to-r from-emerald-100 to-blue-100 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="inline-flex items-center bg-white border border-indigo-200 px-4 py-2 lg:px-6 lg:py-3 rounded-full shadow-sm">
              ...
              <span className="text-indigo-800 font-medium text-sm lg:text-base">Täglich aktuelle Ausschreibungen</span>
            </div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
              Wir beschaffen täglich die aktuellen Ausschreibungen Ihres Interesses, 
              kategorisiert nach Fachrichtung, Region und Objektkategorie aus 
              <span className="font-semibold text-indigo-600"> hunderten verschiedenen Quellen</span>.
            </p>

            {/* CTA Button */}
            <div className="pt-4">
              <button className="group relative bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-700 text-white px-6 py-3 lg:px-8 lg:py-4 rounded-xl font-semibold text-base lg:text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="relative">
              ...
              {/* Floating UI Card - Matching Tenders */}
              <div className="absolute bottom-4 left-4 lg:bottom-6 lg:left-6 bg-white rounded-xl lg:rounded-2xl p-3 lg:p-4 shadow-xl border border-gray-100 max-w-[140px] lg:max-w-[180px]">
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-semibold text-gray-900 text-xs lg:text-sm">Passende Ausschreibungen</span>
                </div>
                
                <div className="flex items-center justify-between mb-2 lg:mb-3">
                  <span className="text-xl lg:text-2xl font-bold text-gray-900">368</span>
                ...
                <div className="w-full bg-gray-200 rounded-full h-1.5 lg:h-2">
                  <div className="bg-gradient-to-r from-indigo-500 to-purple-600 h-1.5 lg:h-2 rounded-full" style={{width: '68%'}}></div>
                </div>
              </div>
            </div>
          </div>
